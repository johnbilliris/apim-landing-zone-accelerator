...
@description('Resource group containing the App Service Environment.')
...
resource aseConfig 'Microsoft.Web/hostingEnvironments/configurations@2022-09-01' existing = {
