@description('The name of the network security group that will be applied to the subnet of the API Management service instance.')
...
// Use Azure Verified Module for Network Security Group
...
// Outputs to maintain compatibility with consuming modules
...
output resourceGroupName string = nsg.outputs.resourceGroupName
